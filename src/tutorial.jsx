...
import {
  CONFIG, LEVERS, CRISIS_INFO, POLITICAL_REGIME_INFO, regimeInfoText, regimeInfoLabel,
      ...
      },
      {
        ...
        body: () => (
          <>
            ...
            <p><b>Валютный кризис</b>: половина резервов истрачена, ставка поднята экстренно, доверия нет — защищать курс дальше или отпустить и получить инфляцию. <b>Ипотечный пузырь</b>: кредитный бум уже был, просрочка растёт, капитал банков на исходе — вопрос не в том, лопнет ли, а в том, кто заплатит. <b>Гиперинфляция</b>: спираль «цены → ожидания → цены» раскручена, долг дорогой, и сбить её можно только ценой рецессии.</p>
