      ...
      },
      {
        ...
        body: ({ economy }) => (
          <>
            ...
            <p>Если кризис всё же наступил, у Минфина есть крайняя мера — реструктуризация долга: она списывает часть долга разом, но закрывает доступ к рынкам на несколько кварталов и бьёт по доверию надолго. Инструмент на самый край, а не рабочий рычаг для повседневного управления бюджетом. Сейчас премия за риск по новому долгу {Math.round(economy.sovereignSpread)} б.п.</p>
          </>
        ),
      },
      {
