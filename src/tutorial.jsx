      ...
      },
      {
        ...
        body: () => (
          <>
            ...
            <p>Если президент всё же начинает военную операцию, воевать приходится на карте. В Норланде три цели: Ледяной перевал у границы, Копи Хальвика и столица Нордхольм — к ней не подойти, пока перевал не взят. Каждый квартал вы выбираете цель и способ: штурм быстро двигает фронт, но стоит денег и потерь; осада медленнее и дешевле; удержание почти не двигает фронт, зато гасит контратаки; перемирие закрывает войну по линии фронта. Сила армии зависит от доли обороны в бюджете и от поддержки в стране. Копи дают экспорт руды, перевал облегчает следующие штурмы, а взятый Нордхольм при остальных целях — капитуляция Норланда. Санкции за войну при этом никуда не деваются.</p>
          </>
        ),
      },
    ],
