...
export function tourSteps({ role, goalLabel }) {
  ...
  return [
    ...
    { target: 'chart', col: 'center', title: 'График', text: 'Появится после первого квартала. Пять главных вкладок видны сразу, остальные — в списке «ещё». Можно включить прогноз на 8 кварталов и сравнить два момента, протянув мышью по графику.' },
