/* =========================================================================================
   ...
   Один и тот же файл используется клиентом и сервером: только так у всех игроков
   совпадают случайные шоки и результаты квартала.
========================================================================================= */
/* =========================================================================================
...
export { CONFIG, ROLES, DIFFICULTIES, GOALS, LEVERS, FX_REGIMES, CB_PERSONAS, MOF_PERSONAS,
  REQUESTS, processRequest, getCbPersona, getMofPersona, personaAfterElection,
  botCentralBank, botFinanceMinistry, defaultDecisions, simulateQuarter, makeInitialEconomy,
  leverPreview, REGIME_INFO, CRISIS_INFO, MANDATE_LABEL, quarterLabel, computeRevenue, clamp };
